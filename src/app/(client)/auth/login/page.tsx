...
function LoginForm() {
  ...
  return (
    <AuthShell
      ...
      title="Sign In"
      subtitle="Access your tickets and continue booking."
      footer={
        <>
    ...
    >
      ...
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-coal/30" />
        </div>
        <div className="relative flex justify-center text-[11px] uppercase tracking-widest">
          <span className="bg-lyante-bg px-3 text-ash">or continue with</span>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2.5 rounded-md border border-coal/40 bg-lyante-surface text-sm font-medium text-ivory py-2.5 hover:border-gold/50 transition-colors cursor-pointer"
      >
